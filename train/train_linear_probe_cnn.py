#!/usr/bin/env python3
"""Frozen continuous CNN ResNet + linear probe, controlled by config."""
...
def main(default_config: str = "case1_probe_cnn") -> None:
    ...
    ckpt_dir = out_root / str(cfg.get("checkpoint_subdir", "checkpoints/cnn_case1"))
